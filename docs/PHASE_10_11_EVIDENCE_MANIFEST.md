...
- Odds-vs-score divergence, recorder enrichment, and movement graph work remain separate productization scope outside the closed reconciliation phase.
- Market/selection timeline parsing and score-history alignment now exist as deterministic contract outputs backed by the current evidence set.
