...
assert.deepEqual([...LIVE_DIVISION_TAGS], [
  "ipbl-66-m-pro-a", "ipbl-66-m-pro-b", "ipbl-66-m-pro-c", "ipbl-66-m-pro-d", "ipbl-66-m-pro-g",
  "ipbl-66-m-pro-u", "ipbl-66-m-pro-z", "ipbl-66-m-pro-l",
  "ipbl-66-w-pro-a", "ipbl-66-w-pro-b", "ipbl-66-w-pro-c", "ipbl-66-w-pro-d", "ipbl-66-w-pro-g", "ipbl-66-w-pro-k",
]);
assert.equal(LIVE_DIVISION_TAGS.includes("ipbl-66-m-pro-g" as never), true, "Men G is part of the approved division list");
...
assert.equal(june.includes("ipbl-66-m-pro-g"), true);
